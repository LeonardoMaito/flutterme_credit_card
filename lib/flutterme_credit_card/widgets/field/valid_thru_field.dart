...
class FMValidThruField extends StatefulWidget {
  /// ## Valid Thru Field
  ///
  /// ### **Type:** `TextFormField` customized.
  /// This is the field that controls the Valid Thru validations which are
  /// immutable. Although other properties like decorations and more
  /// can be customized to fit needs.
  ///
  /// **Validations**
  /// * Takes only digits.
  /// * Allows only 4 characters. First 2 characters represent the month and the
  ///   last 2 represent the year.
  ...
  @override
  State<FMValidThruField> createState() => _FMValidThruFieldState();
}

class _FMValidThruFieldState extends State<FMValidThruField> {
  @override
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      validator: (input) {
        ...
        if (input.length == 5) year = int.parse(input.substring(3, 5));
